...
$post1 = new Post(0, $channel->getID(), $user->getUsername(), "My first test", "Test Test Test!!!", false);
$post2 = new Post(1, $channel->getID(), $user->getUsername(), "My second test", "Test Test Test!!!", true);
